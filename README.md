...
```sql
create trigger tr_UpdateCurrentBalance
On TransactionDetail
after insert
as
begin
    Update b
    set b.CurrentBalance = b.CurrentBalance + i.TransactionAmount
    from bank b
    JOIN inserted i
       on b.AccountNumber = i.AccountNummber
       where i.PaymentType = 'credit';
